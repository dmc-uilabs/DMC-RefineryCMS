...
ActiveRecord::Schema.define(version: 20171006163710) do
  ...
  create_table "refinery_organizations", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "position"
    t.datetime "created_at", null: false
  ...
  create_table "refinery_organizations_addresses", force: :cascade do |t|
    t.string "street1"
    t.string "street2"
    t.string "city"
    t.string "state"
